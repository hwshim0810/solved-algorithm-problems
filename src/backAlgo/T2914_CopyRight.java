...
/**
 * 문제
창영이는 노래 여러 개를 이어서 부르는 가수이다. 유명한 노래의 비슷한 멜로디를 이어서 부르면서 
...
이 때, 평균값은 항상 올림을 해서 정수로 만들어야 한다. 
...
이 때, 적어도 몇 곡이 저작권이 있는 멜로디인지 구하는 프로그램을 작성하시오.
...
class CopyRight {
	...
	public static void main(String[] args) {
		...
		double ans = Math.ceil(((I - 1) + 0.01) * A);
