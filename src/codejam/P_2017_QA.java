 ...
 *
 */
public class P_2017_QA {
	public static void main(String[] args) throws InterruptedException, IOException {
//      BufferedReader br = new BufferedReader(new FileReader("QA_small.in"));
//      FileOutputStream output = new FileOutputStream("QA_small.out");
      BufferedReader br = new BufferedReader(new FileReader("QA_large.in"));
      FileOutputStream output = new FileOutputStream("QA_large.out");
	...
	public static String eval(String input) {
		...
		while (true) {
			int cnt = 0;
			char[] cakes = arr[0].toCharArray();
			int len = cakes.length - K + 1;
